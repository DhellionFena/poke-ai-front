export default function PokedexLayout({
  ...
  return (
    <>
      ...
      <div className="h-[calc(100vh-1.75rem)] overflow-auto bg-red-700 py-5 pl-36 pr-12">
      ...
      {/* bolinhas lateral */}
      <div className="fixed top-0 flex h-[calc(100vh-12rem)] w-7 flex-col items-center justify-end">
      ...
      {/* quadrado */}
      <div className="fixed bottom-0 flex h-44 w-[7.72rem] items-start justify-center border border-zinc-950 border-y-transparent">
      ...
      <div className="fixed bottom-40 left-[4.7rem] h-44 w-[1px] rotate-[147deg] bg-zinc-950"></div>
    </>
  );
}
